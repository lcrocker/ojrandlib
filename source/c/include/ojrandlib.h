...
struct _ojr_generator {
    int _status, seedsize, statesize, bufsize;
...
struct _ojr_algorithm {
    ...
    void (*reseed)(struct _ojr_generator *g, uint32_t *seed, int size);
...
extern void ojr_seed(ojr_generator *g, uint32_t *seed, int size);
extern void ojr_reseed(ojr_generator *g, uint32_t *seed, int size);
extern void ojr_get_seed(ojr_generator *g, uint32_t *seed, int size);
